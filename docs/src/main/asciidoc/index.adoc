...
- GET /api/data/public/users?limit=10 → first 10 users
- GET /api/data/public/users?limit=25&offset=50 → 25 users starting from the 51st row
- GET /api/data/public/users?name=eq.Bob&limit=5 → up to 5 users named Bob
